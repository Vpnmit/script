...
echo -e "\e[1;31m* menu         : List of Main Commands\e[0m"
echo -e ""
...
echo -e "\e[1;31m* [55]\e[0m \e[1;32m: Limit Bandwith Speed Server (under Maintanance)\e[0m"
...
echo -e "\e[1;31m* [59]\e[0m \e[1;32m: Update To Latest Script Version (under Maintanance)\e[0m"
...
echo -e ""
read -p "        Select From Options [1-62 or x]: " port
echo -e ""
case $port in
1)
usernew
