...
echo "#############################################"
echo "ADD COMMAND Shadowsocks-libev"
...
cd /usr/bin
wget -O addss "http://script.vpnmit.xyz/trial/main/tambah/addss.sh"
wget -O delss "http://script.vpnmit.xyz/trial/main/hapus/delss.sh"
wget -O cekss "http://script.vpnmit.xyz/trial/main/cekss.sh"
wget -O xp-ss "http://script.vpnmit.xyz/trial/main/xp-ss.sh"
wget -O renewss "http://script.vpnmit.xyz/trial/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
