...
wget http://script.vpnmit.xyz/trial/main/install/hanyassh.sh && chmod +x hanyassh.sh && screen -S hanyassh.sh ./hanyassh.sh
...
echo " "
echo "=================================-Script Mod VPNMIT-===========================" | tee -a log-install.txt
