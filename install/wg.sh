...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard Already INSTALL, Please addwg FOR ADD client."
	exit 1
fi
...
cd /usr/bin
wget -O addwg "http://script.vpnmit.xyz/trial/main/tambah/addwg.sh"
wget -O delwg "http://script.vpnmit.xyz/trial/main/hapus/delwg.sh"
wget -O cekwg "http://script.vpnmit.xyz/trial/main/cekwg.sh"
wget -O xp-wg "http://script.vpnmit.xyz/trial/main/xp-wg.sh"
wget -O renewwg "http://script.vpnmit.xyz/trial/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
