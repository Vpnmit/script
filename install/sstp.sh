...
#
wget -O /etc/accel-ppp.conf "http://script.vpnmit.xyz/trial/main/accel.conf"
...
wget -O /usr/bin/addsstp http://script.vpnmit.xyz/trial/main/tambah/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp http://script.vpnmit.xyz/trial/main/hapus/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp http://script.vpnmit.xyz/trial/main/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp http://script.vpnmit.xyz/trial/main/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp http://script.vpnmit.xyz/trial/main/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
