...
service xl2tpd restart 2>/dev/nulls
wget -O /usr/bin/addl2tp http://script.vpnmit.xyz/trial/main/tambah/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp http://script.vpnmit.xyz/trial/main/hapus/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/xp-l2tp http://script.vpnmit.xyz/trial/main/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/addpptp http://script.vpnmit.xyz/trial/main/tambah/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp http://script.vpnmit.xyz/trial/main/hapus/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/xp-pptp http://script.vpnmit.xyz/trial/main/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renewpptp http://script.vpnmit.xyz/trial/main/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp http://script.vpnmit.xyz/trial/main/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
