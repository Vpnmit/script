...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "http://script.vpnmit.xyz/trial/main/install/ssrmu.sh"
...
Install_SSR
wget -O /usr/bin/ssr http://script.vpnmit.xyz/trial/main/install/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr http://script.vpnmit.xyz/trial/main/tambah/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr http://script.vpnmit.xyz/trial/main/hapus/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr http://script.vpnmit.xyz/trial/main/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr http://script.vpnmit.xyz/trial/main/renewssr.sh && chmod +x /usr/bin/renewssr
